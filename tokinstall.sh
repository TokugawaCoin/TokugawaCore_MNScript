...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='tokugawa.conf'
CONFIGFOLDER='/root/.tokugawacore'
COIN_DAEMON='tokugawad'
COIN_CLI='tokugawa-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/TokugawaCoin/TokugawaCore_New/files/2752348/Tokugawa-.Daemon_Ubuntu-16.04.tar.gz'
...
function download_node() {
  ...
  wget -q $COIN_TGZ
  tar xzvf Tokugawa-.Daemon_Ubuntu-16.04.tar.gz
  cd rev >/dev/null 2>&1
...
function important_information() {
 ...
 echo -e "${BLUE}================================================================================================================================"
 echo -e "${CYAN}Follow twitter to stay updated.  https://twitter.com/TokugawaCore${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
 echo -e "${CYAN}Ensure Node is fully SYNCED with BLOCKCHAIN.${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
 echo -e "${GREEN}Usage Commands.${NC}"
 echo -e "${GREEN}tokugawa-cli masternode status${NC}"
 echo -e "${GREEN}tokugawa-cli getinfo${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
